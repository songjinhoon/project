...
<body>
<br>
    <p class="text-center" style="font-size: 28px;">ARTHOUSE 영화관 현재 예매율</p>
    <br>
   	<div class="row" style="margin: 0 auto; width: 100%;">
   		<c:forEach var="i" begin="0" end="3">
			<div class="col-lg-3" style="padding-bottom: 0;">
				...
				<a href="http://www.cgv.co.kr/${movieList[i].movieLink}">
					<img class="img-responsive center-block" src="${movieList[i].post}" style="max-width: 100%; height: auto; border: 1px solid gray;">
				</a>
				<p class="text-center" style="border: 1px solid gray;">예매율: ${movieList[i].percent}</p>
			</div>   		
   		</c:forEach>
	</div>
   	<div class="row" style="margin: 0 auto; width: 100%;">
   		<c:forEach var="i" begin="4" end="${size-1}">
			<div class="col-lg-3" style="padding-bottom: 0;">
